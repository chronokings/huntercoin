    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Chrono Kings address (e.g. CJt898fvQDvjw1SBKqxCCd9hpZd4u1Qsn5)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a Chrono Kings address (e.g. CJt898fvQDvjw1SBKqxCCd9hpZd4u1Qsn5)"));
