...
{
    resize(850, 550);
    setWindowTitle(tr("Chronocoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Chronocoin address"));
    ...
    manageNamesAction->setStatusTip(tr("Manage names registered via Chronocoin"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Chronocoin"), this);
    aboutAction->setStatusTip(tr("Show information about Chronocoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Chronocoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Chronocoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Chronocoin addresses"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    if (!GetBoolArg("-testnet"))
    {
        trayIcon->setToolTip(tr("Chronocoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Chronocoin client") + QString(" ") + tr("[testnet]"));
        trayIcon->setIcon(QIcon(":/icons/toolbar_testnet"));
    }
    trayIcon->show();
#endif
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Chronocoin network", "", count));
}
...
{
    QString strTitle = tr("Chronocoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Chronocoin address or malformed URI parameters."),
