...
public:
    ...
    typedef std::vector<std::pair<CScript, int64> > vecSendT;
    ...
    bool CreateTransaction (const vecSendT& vecSend, CWalletTx& wtxNew,
                            CReserveKey& reservekey, int64& nFeeRet);
    bool CreateTransaction(CScript scriptPubKey, int64 nValue, CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet);
    bool CommitTransaction(CWalletTx& wtxNew, CReserveKey& reservekey);
    bool BroadcastTransaction(CWalletTx& wtxNew);
    std::string SendMoney (const CScript& scriptPubKey, int64 nValue,
                           CWalletTx& wtxNew, bool fAskFee = false);
    std::string SendMoney (const vecSendT& vecSend, CWalletTx& wtxNew,
                           bool fAskFee = false);
    std::string SendMoneyToBitcoinAddress(std::string strAddress, int64 nValue, CWalletTx& wtxNew, bool fAskFee=false);
    std::string SendMoneyPrepare (const vecSendT& vecSend, CWalletTx& wtxNew,
                                  CReserveKey& reservekey, bool fAskFee=false);
